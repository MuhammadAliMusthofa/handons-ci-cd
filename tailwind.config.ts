  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-cyber": {
          '0%, 100%': { 
            boxShadow: '0 0 5px hsl(120 100% 50%), 0 0 10px hsl(120 100% 50%), 0 0 15px hsl(120 100% 50%)'
          },
          '50%': { 
            boxShadow: '0 0 10px hsl(120 100% 50%), 0 0 20px hsl(120 100% 50%), 0 0 30px hsl(120 100% 50%)'
          },
        },
        "scan-lines": {
